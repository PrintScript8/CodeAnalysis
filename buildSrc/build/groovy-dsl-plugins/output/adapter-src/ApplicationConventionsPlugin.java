...
/**
 * Precompiled application-conventions script plugin.
 **/
public class ApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("org.jetbrains.kotlinx.kover");
            target.getPluginManager().apply("io.gitlab.arturbosch.detekt");
            target.getPluginManager().apply("com.diffplug.spotless");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ApplicationConventions").asSubclass(BasicScript.class);
