...
/**
 * Precompiled library-conventions script plugin.
 **/
public class LibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_LibraryConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("edu.austral.ingsis.gradle.java-common-conventions");
            target.getPluginManager().apply("java-library");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_LibraryConventions").asSubclass(BasicScript.class);
